module github.com/infraboard/maudit

go 1.20

require (
	github.com/infraboard/mcenter v0.0.18-0.20231121102942-c1bc74a3f456
	github.com/infraboard/mcube v1.9.29-0.20231121103022-78716cbd7db1
