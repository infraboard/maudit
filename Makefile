...
PKG := "github.com/infraboard/maudit"
IMAGE_PREFIX := "github.com/infraboard/maudit"
...
gen: ## Init Service
	@protoc -I=.. --go_out=. --go_opt=module=${PKG} --go-grpc_out=. --go-grpc_opt=module=${PKG} ../maudit/apps/*/pb/*.proto
	@go fmt ./...
